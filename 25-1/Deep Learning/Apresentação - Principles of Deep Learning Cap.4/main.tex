...
\begin{frame}{4.1 - Hubbard-Stratonovich}
    Completando quadrados mais uma vez na exponencial, retomando o sobrescrito $(1)$:
    \tiny
    \begin{gather*}
...
\begin{frame}{4.1 - Hubbard-Stratonovich}
    ...
    \begin{gather*}
        p(z \mid D) =  \int \left[ \prod_{j,\alpha} \frac{d\Lambda_{j\alpha}}{2\pi} \right] 
        \exp \left[- \frac{1}{2} \sum_{j,\alpha_1\alpha_2} \Lambda_{j}^{\alpha_1}\Lambda_{j}^{\alpha_2} G_{\alpha_1\alpha_2}
        + i \sum_{j,\alpha} \Lambda_{j}^{\alpha} z_{j;\alpha} \right] \\
        = \textcolor{orange}{\int \left[ \prod_{j,\alpha} \frac{d\Lambda_{j\alpha}}{2\pi} \right] \exp \left[- \frac{1}{2} \sum_{j, \alpha_1, \alpha_2} 
            G^{(1)}_{\alpha_1 \alpha_2} \left(
            \Lambda_{\alpha_1 j} - i \sum_{\beta_1} G_{(1)}^{\alpha_1 \beta_1} z^{(1)}_{j; \beta_1}
            \right)
            \left(
            \Lambda_{\alpha_2 j} - i \sum_{\beta_2} G_{(1)}^{\alpha_2 \beta_2} z^{(1)}_{j; \beta_2}
            \right) \right]} \\
            \times \exp \left[- \frac{1}{2} \sum_{j, \alpha_1, \alpha_2} G_{(1)}^{\alpha_1 \alpha_2} z^{(1)}_{j; \alpha_1} z^{(1)}_{j; \alpha_2}
            \right] \\
            = \textcolor{orange}{\frac{1}{|2\pi G^{(1)}|^{\frac{n_1}{2}}}} \exp \left[- \frac{1}{2} \sum_{j, \alpha_1, \alpha_2} G_{(1)}^{\alpha_1 \alpha_2} z^{(1)}_{j; \alpha_1} z^{(1)}_{j; \alpha_2}
            \right]
    \end{gather*}
