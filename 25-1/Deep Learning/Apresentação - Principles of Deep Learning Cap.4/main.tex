...
\begin{frame}{4.1 - Hubbard-Stratonovich}
    ...
    = - \frac{1}{2} \sum_{i, \alpha_1, \alpha_2} \left[
        ...
        \Lambda_{\alpha_1 i} - i \sum_{\beta_1} G_{(1)}^{\alpha_1 \beta_1} z^{(1)}_{i; \beta_1}
        \right)
        \left(
        \Lambda_{\alpha_2 i} - i \sum_{\beta_2} G_{(1)}^{\alpha_2 \beta_2} z^{(1)}_{i; \beta_2}
        \right) 
        + G_{(1)}^{\alpha_1 \alpha_2} z^{(1)}_{i; \alpha_1} z^{(1)}_{i; \alpha_2}
        \right]
    \end{gather*}
\end{frame}
...
\begin{frame}{4.1 - Hubbard-Stratonovich}
    ...
    \begin{gather*}
        ...
        + i \sum_{j,\alpha} \Lambda_{j}^{\alpha} z_{j;\alpha} \right] \\
        = \textcolor{orange}{\int \left[ \prod_{i,\alpha} \frac{d\Lambda_{i\alpha}}{2\pi} \right] \exp \left[- \frac{1}{2} \sum_{j, \alpha_1, \alpha_2} 
            G^{(1)}_{\alpha_1 \alpha_2} \left(
